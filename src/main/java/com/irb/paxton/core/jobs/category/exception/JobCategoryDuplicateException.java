...
public class JobCategoryDuplicateException extends RuntimeException implements GraphQLError {
    ...
    public JobCategoryDuplicateException(String message, String path) {
        super(message);
        this.path = path;
    }
