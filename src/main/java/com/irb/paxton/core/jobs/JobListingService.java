...
public class JobListingService {
    ...
    @Transactional
    @PostAuthorize("hasRole('ROLE_ADMINISTRATOR') or hasRole('ROLE_RECRUITER') or @paxtonSecurityService.isOrganizationRecruiter(authentication, returnObject.organization)")
