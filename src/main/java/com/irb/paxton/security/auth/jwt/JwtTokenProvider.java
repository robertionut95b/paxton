...
public class JwtTokenProvider {
    ...
    public String generateTokenFromUserDetails(UserDetails userDetails) {
        ...
        return Jwts.builder()
                ...
                .claim(jwtProperties.getRolesClaimName(), ((PaxtonUserDetails) userDetails).getUserRolesAsString())
    ...
    public String generateTokenFromUser(User user) {
        ...
        return Jwts.builder()
                ...
                .setId(UUID.randomUUID().toString())
                .claim(jwtProperties.getPermissionsClaimName(), establishScope(userDetails.getAuthorities()))
                .claim(jwtProperties.getRolesClaimName(), user.getUserRolesAsString())
