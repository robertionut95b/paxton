...
export const APP_API_WS_BASE_URL = "ws://localhost:8080";
export const APP_API_PATH = `/api/v${APP_API_VERSION}`;
export const APP_IMAGES_API_PATH = `${APP_API_BASE_URL}${APP_API_PATH}/images`;
export const APP_UPLOADS_API_PATH = `${APP_API_BASE_URL}${APP_API_PATH}/uploads`;
