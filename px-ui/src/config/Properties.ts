import { VITE_REACT_APP_SERVER_BASE_URL } from ".";

export const IS_ENV_PROD = Boolean(import.meta.env.PROD);

export const APP_API_VERSION = 1;
export const APP_API_BASE_URL = VITE_REACT_APP_SERVER_BASE_URL;
const APP_API_WS_BASE_URL = IS_ENV_PROD ? "" : "ws://localhost:8080";
